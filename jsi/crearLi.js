    ...
    for(i=0; i<matriz.length; i++){
        ...
        for(j=0; j<matriz[i].length;j++){
            ...
            if(!eliminarFilas(matriz, n_col)){
                ...
                document.getElementById("independiente").innerHTML = "&there4;No es un espacio generador";
                solucion=1;
    ...
    for(i=0; i<matriz.length; i++){
        ...
        for(j=0; j<matriz[i].length-1; j++){
            if(matriz[i][j]==1&&j==i){
                ...
                independiente="&there4;Si es linealmente independiente"
                for(k=(j+1), m=(matriz[i].length-i); k<matriz[i].length-1; k++, m--){
                    if(matriz[i][k]==0){
                        suma=suma+"";
                    }else{
                        document.getElementById('Resultados2').innerHTML="El sistema tiene soluciones infinitas <br><br>";
                        independiente="&there4;No es linealmente independiente (es linealmente dependiente)"
                        //suma+="(";
                        if(matriz[i][k]>0){
                            /*
